...
export class LEDNode {
	constructor(pos){
        ...
        // To preserve orientation, rotate around y axis, then z
        ...
        this.positions = []
        for(let k of BYTE_ORDER){
            this.leds[k] = LED_LAYOUT[k].clone().setX(r).applyEuler(euler) 
            this.positions.push(this.leds[k])
        }
    }
